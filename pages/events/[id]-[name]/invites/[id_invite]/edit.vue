...
const title = "Modifier l'invité - Who's coming - Organisateur d'évènements";
const desc = "Modifiez les détails de votre invité sur Who's coming. Mettez à jour les informations telles que le prénom, le nom et le numéro de téléphone de l'invité."
