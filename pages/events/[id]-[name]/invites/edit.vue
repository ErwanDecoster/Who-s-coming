	...
	<div class="container">
		...
		<template v-if="data?.invites_by_state">
			...
			<div v-if="data.invites_by_state[1]" class="grid gap-1">
				...
				<InvitesViewDelete :invites="data.invites_by_state[1]" :isEdit="true" />
			</div>
			<div v-if="data.invites_by_state[2]" class="grid gap-1">
				...
				<InvitesViewDelete :invites="data.invites_by_state[2]" :isEdit="true" />
			</div>
			...
			<div v-if="data.invites_by_state[4]" class="grid gap-1">
				...
				<InvitesViewDelete :invites="data.invites_by_state[4]" :isEdit="true" />
			</div>
			<div v-if="data.invites_by_state[6]" class="grid gap-1">
				...
				<InvitesViewDelete :invites="data.invites_by_state[6]" :isEdit="true" />
			</div>
