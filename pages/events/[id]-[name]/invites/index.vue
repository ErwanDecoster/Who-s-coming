...
<template>
	<div class="container">
		...
		<template v-if="data?.invitesByState">
			<h3>Liste des invités - {{ data.invitesByState[2].length + data.invitesByState[3].length }} {{ (data.invitesByState[2].length + data.invitesByState[3].length > 1) ? 'invités confirmé' : 'invité confirmé' }} </h3>
